...
class _MeanMIL_s24(_nn_s24.Module):
    def __init__(self):
        super().__init__()
        self.net = _nn_s24.Sequential(_nn_s24.Linear(68, 64), _nn_s24.LayerNorm(64), _nn_s24.ReLU(), _nn_s24.Linear(64, 1), _nn_s24.Sigmoid())
...
class _ABMIL_s24(_nn_s24.Module):
    def __init__(self):
        super().__init__()
        self.feat = _nn_s24.Sequential(_nn_s24.Linear(68, 64), _nn_s24.LayerNorm(64), _nn_s24.ReLU())
...
class _BiLSTM_s24(_nn_s24.Module):
    def __init__(self):
        super().__init__()
        self.proj = _nn_s24.Sequential(_nn_s24.Linear(68, 64), _nn_s24.LayerNorm(64))
        self.lstm = _nn_s24.LSTM(64, 64, num_layers=1, batch_first=True, bidirectional=True)
        self.clf  = _nn_s24.Sequential(_nn_s24.Linear(128, 1), _nn_s24.Sigmoid())
    def forward(self, x):
        _, (hn, _) = self.lstm(self.proj(x).unsqueeze(0))
...
class _GRUModel_s24(_nn_s24.Module):
    def __init__(self):
        super().__init__()
        self.proj = _nn_s24.Sequential(_nn_s24.Linear(68, 64), _nn_s24.LayerNorm(64))
        self.gru = _nn_s24.GRU(64, 64, num_layers=2, batch_first=True, dropout=0.1)
        self.clf = _nn_s24.Sequential(_nn_s24.Linear(64, 32), _nn_s24.ReLU(), _nn_s24.Linear(32, 1), _nn_s24.Sigmoid())
    def forward(self, x):
        _, hn = self.gru(self.proj(x).unsqueeze(0)); return self.clf(hn[-1]), None
